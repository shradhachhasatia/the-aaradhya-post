...
export const cover = {
  estYear: "Est. 2026",
  circulation: "Circulation: One",
  parAvion: "Par Avion · First Class",
  logoWord: "Aaradhya",
  logoRest: "Post",
  ...
  printedLine: "Printed with love by the editor",
};

export const letter = {
  eyebrow: "A Letter",
  headline: "Some things I keep",
  headlineEmphasis: "meaning",
  headlineRest: "to tell you.",
  recipient: "Aaradhya",
  from: "The Editor",
};
...
export const songs = {
  ...
  headline: "Songs I'd mail you",
  tagline: "press play in your head",
  trackOfWeekLabel: "Track Of The Week",
  restLabel: "The Rest Of The Mixtape",
  sideLabel: "Side A",
};
